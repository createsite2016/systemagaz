...
<section class="panel">
<br><b><span class="center"> | <a class="btn btn-sm btn-info" data-toggle="modal" href="#modal"><i class="icon-money"></i> Новый магазин</a> | </span></b><br><br>
...
if ($user_role=='1') {
                        $sql_get_device = mysql_query("SELECT * FROM `magazins` ORDER BY `name` DESC ",$db);
                  ...
                  <tr>
                    ...
                    <td><a href="fl_del_magaz.php?id=<?php echo $data_get_device['id']; ?>"><font color="red">Удалить</font></a>
...
<?php }} ?>
                    ...
                    <form class="m-b-none" action="fl_post_add_magaz.php" method="POST">
