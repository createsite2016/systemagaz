...
?>
                  <tr>
                    <td>
<?php echo $data_get_device['profes'];// должность ?>
                    </td>
                    <td>
<?php echo $data_get_device['name'];// проффесия ?>
                    </td>
                    <td>
<?php echo $data_get_device['login']; // логин ?>
                    </td>
                    <td>
<?php echo $data_get_device['password'];// пароль ?>
                    </td>
<td>
<div class="btn-group">
