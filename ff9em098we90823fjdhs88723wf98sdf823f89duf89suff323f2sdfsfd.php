...
$login = "login";
$password = "password";
$security_line = "mbn-fmby_iuoufJKG!FEjgud5a890g";

# База данных (Database)
$dbhost = "localhost"; # Хост базы данных (Database host)
$dbuname = "cv93805_bd";     # Имя пользователя базы данных (Database user name)
$dbpass = "16213150z";      # Пароль пользователя базы данных (Database user password)
$dbname = "cv93805_bd";   # Имя базы данных (Database name)
...
$language = 'ru'; // Варианты языка: ru или en (You can change to 'ru' or 'en')
...
$font_size = 12; // Размер шрифта в редакторе (Font size for coding)
