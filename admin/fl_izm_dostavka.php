...
<?php
$id = $_GET['id'];
$get_params = mysql_query("SELECT * FROM `dostavka` WHERE `id`='$id' ",$db); //извлекаем из базы все данные о пользователе с введенным логином
$params = mysql_fetch_array($get_params);
?>
<section class="panel">
            <div class="panel-body">
              <form action="fl_post_izm_dostavka.php" class="form-horizontal" method="POST" data-validate="parsley">      
