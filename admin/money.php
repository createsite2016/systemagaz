...
if ($user_role=='1') {
    $sql_get_device = $pdo->getRows("SELECT * FROM `money` ORDER BY `name` DESC ");
    foreach ( $sql_get_device as $data_get_device) { ?>
                  <tr>
                    ...
                    <td><a href="classes/App.php?action=del_money&id=<?php echo $data_get_device['id']; ?>"><font color="red">Удалить</font></a>
