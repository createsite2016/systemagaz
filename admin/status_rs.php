...
<section class="panel">
<br><b><span class="center"> | <a class="btn btn-sm btn-info" data-toggle="modal" href="#modal"><i class="icon-minus"></i> Новый статус расхода</a> | </span></b><br><br>
            <div class="table">
...
if ($user_role=='1') {
                        $sql_get_device = mysql_query("SELECT * FROM `status_rs` ORDER BY `name` DESC ",$db);
                  ...
                  <tr>
                    ...
                    <td><a href="fl_del_status_rs.php?id=<?php echo $data_get_device['id']; ?>"><font color="red">Удалить</font></a>
                    <a href="fl_izm_status_rs.php?id=<?php echo $data_get_device['id']; ?>"><font color="Green">Изменить</font></a></td>
                  </tr>
<?php }}
...
<?php }} ?>
                    ...
                    <form class="m-b-none" action="fl_post_add_status_rs.php" method="POST">
                    <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><i class="icon-remove"></i></button>
                    <h4 class="modal-title" id="myModalLabel"><i class="icon-edit"></i>Новый статус расхода</h4>
                    </div>
