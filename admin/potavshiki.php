...
if ($user_role=='1') {
                        $sql_get_device = mysql_query("SELECT * FROM `postavshiki` ORDER BY `name` DESC ",$db);
                  ...
                  <tr>
                    ...
                    <td><a href="fl_del_postavshik.php?id=<?php echo $data_get_device['id']; ?>"><font color="red">Удалить</font></a>
...
<?php }} ?>
                    ...
                    <form class="m-b-none" action="fl_post_add_postavshik.php" method="POST">
