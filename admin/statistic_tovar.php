                            ...
                            <div class="table-responsive">
                                <table class="table table-striped b-t text-small">
                                    ...
                                    if ($user_role=='3') {
                                        ...
                                        $sql_products = $pdo->getRows("SELECT * FROM `statistic` WHERE `caption` =  ? GROUP BY `id_statistic` ORDER BY `datatime`",['tovar']);
                                        foreach ( $sql_products as $data_statistic ) {
                                            ...
                                            $sql_tovar = $pdo->getRows("SELECT * FROM `tovar` WHERE `id` =  ?",[$data_statistic['id_statistic']]);
                                            foreach ( $sql_tovar as $tovar ) { }
                                            ?>
                                            <tr>
                                                <td><a target="_blank" href="../product.php?id=<?php echo $tovar['id']; ?>&statistic=false">
                                                        <?php echo $tovar['name']; ?><br>
                                                        Цена: <?php echo $tovar['chena_output']; ?><br>
                                                        Описание: <?php echo $tovar['komment']; ?><br>
                                                        Артикул:<?php echo $tovar['article']; ?><br>
                                                        <img src="foto_tovar/../../<?php echo $tovar['image']; ?>" alt="<?php echo $tovar['name']; ?>" width="120" height="120"></a></td>
