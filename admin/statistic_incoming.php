                            ...
                            <div class="table-responsive">
                                <table class="table table-striped b-t text-small">
                                    ...
                                    if ($user_role=='3') {
                                        ...
                                        $sql_products = $pdo->getRows("SELECT * FROM `statistic` WHERE `caption` =  ? ORDER BY `datatime`",['user']);
                                        foreach ( $sql_products as $data_statistic ) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    echo $data_statistic['ip'];
                                                    echo '<br>';
                                                    $xml_file = 'http://ipgeobase.ru:7020/geo?ip='.$data_statistic['ip'];
