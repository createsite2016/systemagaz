...
//$us_ids = mysql_fetch_array($sql_us);
 ?>
      <li class="dropdown-submenu"><a href="index.php"><i class="icon-shopping-cart icon-xlarge"></i><span>Заказы</span>
...
if ($user_role=='3') { ?>
      ...
      <li class="dropdown-submenu">
          <a href="#"><i class="icon-bar-chart icon-xlarge"></i><span>БухУчет</span></a>
          <ul class="dropdown-menu">
      ...
      <li class="dropdown-submenu">
          <a href="#"><i class="icon-shopping-cart icon-xlarge"></i><span>Магазин</span></a>
          <ul class="dropdown-menu">
              ...
              <li><a href="zayavki.php"><i class="icon-envelope-alt icon-xlarge"></i>
                      ...
                      <?}
                      ?><span>Заявки на обратный звонок
        ...
        <li class="dropdown-submenu">
            ...
            <ul class="dropdown-menu">
                <li><a href="status.php"><i class="icon-flag"></i>Статусы (Заказы)</a></li>
    ...
    <li class="dropdown-submenu">
        <a href="#"><i class="icon-eye-open icon-xlarge"></i><span>Аналитика (beta)</span></a>
        <ul class="dropdown-menu">
            <li><a href="statistic_tovar.php"><i class="icon-gift"></i>Просмотренные товары</a></li>
            <li><a href="statistic_categor.php"><i class="icon-folder-close-alt"></i>Просмотренные категории</a></li>
